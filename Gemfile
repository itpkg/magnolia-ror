...
gem 'spree_related_products', git: 'https://github.com/spree-contrib/spree_related_products.git', branch: '3-1-stable'
gem 'spree_static_content', git: 'https://github.com/spree-contrib/spree_static_content.git', branch: '3-1-stable'
gem 'spree_recently_viewed', git: 'https://github.com/spree-contrib/spree_recently_viewed.git', branch: '3-1-stable'
gem 'spree_editor', git: 'https://github.com/spree-contrib/spree_editor.git', branch: '3-1-stable'
