...
set :repo_url, 'https://github.com/itpkg/magnolia.git'
...
append :linked_dirs, 'log', 'tmp/pids', 'tmp/cache', 'tmp/sockets', 'tmp/sessions', 'public/system', 'public/ckeditor_assets'
